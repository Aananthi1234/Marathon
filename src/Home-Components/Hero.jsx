...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    // Call updateCountdown immediately to set initial time left
    updateCountdown();
  ...
  return (
    <>
      ...
      <div className="lg:w-[90%] text-white flex flex-col justify-center items-center shadow-lg  rounded-lg gap-6  lg:my-10 py-8 border-2 border-em"style={{
        ...
        <h1 className="text-secondary  lg:text-3xl text-lg font-semibold tracking-wide font-mono"style={{ textShadow: "2px 2px 2px rgba(0,0,0,0.7)" }}>
