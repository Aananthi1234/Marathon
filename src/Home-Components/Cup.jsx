...
const Cup = () => {
    ...
    return (
        <div className="relative w-full h-auto flex justify-center  bg-black items-center">
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-3 gap-20 ">
                        {icons.map((choose, index) => (
                            <div key={index} className="flex flex-col items-center">
                                ...
                                <p className="lg:text-lg font-semibold text-white mt-3 tracking-wider text-center"style={{textShadow:"0px 2px 2px rgba(0,0,0,0.7)"}}>{choose.text}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 lg:gap-20 gap-10">
                        {icons1.map((choose1, index) => (
                            <div key={index} className="flex flex-col items-center">
                                ...
                                <p className="lg:text-lg font-semibold text-white mt-3 tracking-wider"style={{textShadow:"0px 2px 2px rgba(0,0,0,0.7)"}}>{choose1.text}</p>
                            </div>
                        ))}
                    </div>
                </div>
