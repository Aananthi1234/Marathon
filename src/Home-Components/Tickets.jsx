      ...
      <div className="w-full h-auto container mx-auto lg:py-20 py-10">
        <div className="w-full lg:h-[500px] flex lg:flex-row flex-col items-center justify-center lg:gap-10 gap-5 lg:px-10 px-5">
          ...
          <div className="flex flex-col items-center justify-center hover:scale-[1.05] transform transition-all duration-500 ">
            <div className="border-[1px] hover:border-2 border-green-300 text-center shadow-xl hover:shadow-2xl w-[350px] lg:h-[400px] h-[350px] rounded-lg lg:py-10 ">
              <h2
          ...
          <div className="flex flex-col items-center justify-center hover:scale-[1.05] transform transition-all duration-500">
            <div className="border-[1px] hover:border-2 border-red-300 text-center  shadow-xl hover:shadow-2xl  w-[350px] lg:h-[450px] h-[360px] rounded-lg lg:py-8">
              <h1
              ...
              <p className="tracking-wider ">
                <h2
                  className="lg:text-4xl text-2xl font-extrabold tracking-wider lg:px-10 px-5 py-4 lg:py-7 bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 text-white my-5 text-center"
                  style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.7)" }}
                >
                  Rs.100
                </h2>
          ...
          {/* Ticket 3 */}
          <div className=" flex flex-col items-center justify-center hover:scale-[1.05] transform transition-all duration-500">
            <div className="border-[1px] hover:border-2 border-blue-300 text-center  shadow-xl hover:shadow-2xl w-[350px] lg:h-[400px] h-[350px] rounded-lg lg:py-10">
              <h2
